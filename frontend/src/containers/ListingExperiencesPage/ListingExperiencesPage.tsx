...
export interface ListingCaterersPageProps {
  className?: string;
}
...
const ListingCaterersPage: FC<ListingCaterersPageProps> = ({
  className = "",
}) => {
  return (
    <div
      className={`nc-ListingCaterersPage relative overflow-hidden ${className}`}
      ...
      <div className="container relative">
        ...
        <div className="relative py-16">
          ...
          <SectionSliderNewCategories
            ...
            sliderStyle="style2"
            uniqueClassName="ListingCaterersPage"
          />
        </div>
...
export default ListingCaterersPage;
